/*
DELETE .SQL files in N:\All Business Units\Common Data\Business Analyst Team\SQL Queries\Temp Queries before running
*/
...
CURDATE(), '`;')
INTO OUTFILE 'N:/All Business Units/Common Data/Business Analyst Team/SQL Queries/Temp Queries/Master Marked At Risk AND Prom Ship Commit Alignment Data Dump.sql'
LINES TERMINATED BY '\r\n';