...
CURDATE(), '`;')
INTO OUTFILE 'N:/All Business Units/Common Data/Business Analyst Team/SQL Queries/Temp Queries/Master On Time Percentage AND Late OPD Percentage Data Dump.sql'
LINES TERMINATED BY '\r\n';